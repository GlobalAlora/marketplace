  ...
  return (
    <Link
      ...
      className={[
        ...
        // Todos los cards comparten la misma base blanca.
        // Los destacados se diferencian solo con un acento izquierdo de 3px.
        d
          ? 'bg-white border-l-[3px] border-l-[#FFC107] border-t border-r border-b border-gray-200 hover:shadow-md'
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
        ...
        {/* Badge destacado — discreto, solo texto sobre blur */}
        {d && (
          <span className="absolute top-2 left-2 text-[9px] font-extrabold tracking-widest text-white bg-black/50 backdrop-blur-sm px-2 py-0.5 rounded-full uppercase">
            ★ Dest.
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col flex-1 p-4 gap-2">
        <h3 className="font-semibold text-sm leading-snug line-clamp-2 text-gray-900 group-hover:text-[#282F8F] transition-colors">
          {vehiculo.titulo}
        </h3>
        ...
        <div className="mt-auto pt-2 flex items-end justify-between">
          ...
          {vendedor && (
            <span className="text-xs truncate max-w-[100px] text-gray-400">
              {vendedor}
            </span>
          )}
        </div>
